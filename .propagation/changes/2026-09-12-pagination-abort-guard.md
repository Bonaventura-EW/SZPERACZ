...
surface: scraper.py (_scrape_one_profile_playwright, scrape_with_playwright_all, is_incomplete_scrape, append_history, generate_dashboard_json, generate_api_json)
...
U nas ręczna korekta ostatecznie nie była potrzebna — powtórzony tego samego dnia skan
przeszedł poprawnie i nadpisał zły dzień w obu źródłach.
